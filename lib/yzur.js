...
const YZUR = {
  ...
  Roll: {
    baseTemplate: '/systems/coriolis-tgd/templates/dice/broll.hbs',
    chatTemplate: "/systems/coriolis-tgd/templates/dice/roll.hbs",
    tooltipTemplate: "/systems/coriolis-tgd/templates/dice/tooltip.hbs",
    infosTemplate: "/systems/coriolis-tgd/templates/dice/infos.hbs",
  },
  Dice: {
...
class YearZeroRoll extends Roll {
  ...
  get isSimpleRoll() {
    return !this.terms.some(t => t instanceof BaseDie || t instanceof SkillDie);
  }
